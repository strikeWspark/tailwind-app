        ...
        <div className='w-full py-16 bg-white px-4'>
            <div className='max-w-[1240px] mx-auto grid lg:grid-cols-3'>
                <div className='lg:col-span-2 my-4'>
                    ...
                    <p className=''>Sign up to out newsletter and stay up to date.</p>
                </div>
                <div className='my-4'>
                    <div className='flex flex-col sm:flex-row items-center justify-between w-full'>
                        <input className='p-3 flex w-full rounded-md text-black border-2 border-grey-900 solid' type="email" placeholder='Enter Email' />
