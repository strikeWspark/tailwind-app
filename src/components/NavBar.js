...
const NavBar = () => {
    ...
    return (
        <nav className={scrolled? 'flex justify-between items-center h-24 mx-auto px-4 text-white fixed-navbar scrolled':'flex justify-between items-center h-24 mx-auto px-4 text-white fixed-navbar '}>
